...
import type { ImageComponent, LatexComponent, TextComponent, TextInputComponent } from '$lib/domain/components/DefaultComponents.js';
...
export type DefaultComponents = TextComponent | TextInputComponent | ImageComponent | LatexComponent;
